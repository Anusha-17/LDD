...
MODULE_DESCRIPTION("A Sample module param driver");
MODULE_VERSION("1.0");
...
const struct kernel_param_ops my_param_ops =                 //Funtion Pointer
{
	.set = &notify_param, // Use our setter ... (To Store)
	.get = &param_get_int, //..and standard getter 
};

module_param_cb(cb_myValue, &my_param_ops, &cb_myValue, S_IRUSR|S_IWUSR);
/*-----------------------------------------------------------------*/
